<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="admStudents.ascx.vb" Inherits="Sinai_eIEP.admStudents" %>

<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register Src="~/admin/admStudentInfo.ascx" TagName="AdminStudentInfo" TagPrefix="uc" %>
<%@ Register Src="~/admin/admInclusions.ascx" TagName="AdminInclusions" TagPrefix="uc" %>
<%@ Register Src="~/admin/admServices.ascx" TagName="AdminServices" TagPrefix="uc" %>
<%@ Register Src="~/Admin/admAccommodations.ascx" TagName="AdminAccommodations" TagPrefix="uc" %>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="server=dsrcvjfaa9.database.windows.net;database=eiep;uid=eiep_admin;password=Klonimus55;"
        ...
        InsertCommand="INSERT INTO [dbo].[students] ([student_uuid], [student_first_name], [student_last_name], [is_active], [current_placement], [school_id], [student_sex], [school_year]) VALUES (NEWID(), @student_first_name, @student_last_name, 1, @current_placement, @school_id, @student_sex, @school_year)">
        <SelectParameters>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" TypeName="DDLists" SelectMethod="getGenderList" ></asp:ObjectDataSource>
    ...
    <asp:table ID="Table1" runat="server" CellPadding="2" CellSpacing="2" Width="1000px" BorderStyle="Solid" BorderWidth="1">
        <asp:TableRow>
            ...
            <asp:TableCell Width="25%">School Year</asp:TableCell>
...
<telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" AllowSorting="True" CellSpacing="0" GridLines="None" DataSourceID="SqlDataSource1" AllowAutomaticUpdates="true" AllowAutomaticDeletes="true" AllowAutomaticInserts="true" >
    <MasterTableView AutoGenerateColumns="False" DataKeyNames="student_uuid" DataSourceID="SqlDataSource1" EditMode="EditForms" InsertItemDisplay="Top" PageSize="15" CommandItemDisplay="Top">
        <Columns>
            ...
            <telerik:GridDropDownColumn UniqueName="student_sex" DataType="System.String" HeaderText="Gender" ColumnEditorID="GridDropDownListColumnEditor2" DataField="student_sex" ListTextField="student_gender" ListValueField="student_gender" DataSourceID="ObjectDataSource1" ItemStyle-Width="200px">
        ...
        <EditFormSettings EditFormType="Template">
            <FormTemplate>
                <asp:Table ID="Table1" runat="server" Width="750px">
                    ...
                    <asp:TableRow>
                        <asp:TableCell>DOB: <telerik:RadDatePicker ID="RadDatePicker1" runat="server" DbSelectedDate='<%# Bind("date_of_birth") %>'></telerik:RadDatePicker>&nbsp;
                            Gender: <asp:DropDownList ID="ddGender" runat="server" SelectedValue='<%# Bind("student_sex")%>' DataSource='<%# (New String() {"F", "M"})%>' AppendDataBoundItems="True">
                                        <asp:ListItem Selected="True" Text="Select" Value=""></asp:ListItem>
                                    </asp:DropDownList>
                        </asp:TableCell>
                ...
                <telerik:RadTabStrip runat="server" Width="995px" ID="tbAdmin" Align="Justify" AutoPostBack="true" MultiPageID="RadMultiPage1"  SelectedIndex="0">
                    <Tabs>
                        <telerik:RadTab Width="310px" Text="Inclusions"></telerik:RadTab>
                        <telerik:RadTab Width="310px" Text="Services"></telerik:RadTab>
                        <telerik:RadTab Width="310px" Text="Accommodations"></telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
                <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0">
                    
                    <telerik:RadPageView runat="server" Width="950px" Height="255px" ID="RadPageView1">
                        <div class="contentWrapper">
                            <uc:AdminInclusions runat="server" ID="AdminInclusions" />
                        </div>
                    </telerik:RadPageView>
                    <telerik:RadPageView runat="server" Width="950px" Height="255px" ID="RadPageView2">
                        <div class="contentWrapper">
                            <uc:AdminServices runat="server" ID="AdminServices" />
                        </div>
                    </telerik:RadPageView>
 
                    <telerik:RadPageView runat="server" Width="950px" Height="255px" ID="RadPageView3">
                        <div class="contentWrapper">
                            <uc:AdminAccommodations runat="server" ID="AdminAccommodations" />
                        </div>
                    </telerik:RadPageView>
...
<telerik:GridDropDownListColumnEditor ID="GridDropDownListColumnEditor2" runat="server" DataValueField="student_sex"  />