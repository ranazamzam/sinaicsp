...
#Region "Web Form Designer generated code"
    ...
    Private Sub InitializeComponent()
        AddHandler DataBinding, AddressOf Me.iepDetails_DataBinding
...
#End Region
    ...
    Protected Sub iepDetails_DataBinding(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not (TypeOf DataItem Is Telerik.Web.UI.GridInsertionObject) Then
            ...
            txtYear.Text = DataBinder.Eval(DataItem, "iep_year")

        Else
            If Month(Now) >= 7 Then
                txtYear.Text = Year(Now).ToString & " - " & (Year(Now) + 1).ToString
            Else
                txtYear.Text = (Year(Now) - 1).ToString & " - " & Year(Now).ToString
            End If
            ddStudent.DataBind()
    ...
    Private Sub cmbTeacher_DataBound(sender As Object, e As EventArgs) Handles cmbTeacher.DataBound
        If (TypeOf DataItem Is Telerik.Web.UI.GridInsertionObject) Then
            If Not cmbTeacher.FindItemByValue(DirectCast(Me.Page, eiep_main).usrUuid) Is Nothing Then
                cmbTeacher.SelectedValue = DirectCast(Me.Page, eiep_main).usrUuid
            End If
    ...
    Protected Sub ddSubjects_DataBound(sender As Object, e As EventArgs) Handles ddSubjects.DataBound
        ...
        If (Not TypeOf DataItem Is Telerik.Web.UI.GridInsertionObject) Then
            ...
            Try
                ...
                If ddSubjects.SelectedText Like "*Other (specify subject name below)" Then txtSubject.Style.Item("display") = "block"
            Catch
            End Try
        End If
